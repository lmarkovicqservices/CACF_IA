...
- [x] Recibir mensajes desde WhatsApp (webhook configurado).
- [x] Validar el número del socio.
- [x] Clasificar el tipo de consulta.
- [x] Responder consultas técnicas usando documentos cargados.
- [x] Responder consultas generales o saludos.
- [x] Enviar la respuesta de vuelta por WhatsApp.

### Componentes del proyecto que ya existen
- Estructura base de FastAPI.
- Webhook de entrada.
- Endpoints de health y testing.
- Organización por módulos: API, auth, whatsapp, rag, pricing, agent.
- Motor RAG con ChromaDB + GPT-4o.
- Cliente API de precios (4 endpoints reales conectados).
- Scripts de testing y evaluación.

### Qué falta completar para que el MVP quede sólido
- [ ] Configurar app Meta Business para WhatsApp (número de prueba).
- [ ] Deploy en DonWeb VPS con Docker.
...
- [x] Definir claramente el problema.
- [x] Explicar por qué el canal WhatsApp es adecuado.
- [x] Definir el alcance del MVP.

### Preparación técnica
- [x] Mostrar la arquitectura del sistema.
- [x] Explicar cómo funciona el motor RAG.
- [x] Mostrar cómo se integran los módulos del proyecto.
